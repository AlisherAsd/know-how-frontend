      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-[32px] bg-white/80 p-6 shadow-[0_30px_90px_-60px_rgba(15,23,42,0.45)]">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Новый пользователь получает эфиры сразу и не упирается в пустой экран или отсутствие
            контента.
          </p>
        </div>
        <div className="rounded-[32px] bg-slate-950 p-6 text-white shadow-[0_35px_110px_-65px_rgba(15,23,42,1)]">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-300">
            Курсы выглядят как компактные образовательные продукты с уроками, материалами и внятной
            подачей.
          </p>
        </div>
