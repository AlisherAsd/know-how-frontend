import { useMyCourses } from "@/entities/courses/composables/useCourses";
    ...
    <div className="space-y-8 py-8 sm:py-10">
      <section className="rounded-[40px] border border-white/70 bg-white/80 p-8 shadow-[0_35px_100px_-60px_rgba(15,23,42,0.45)] sm:p-10">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-500">
          Это экран, где потом удобно показывать прогресс, пройденные уроки, оставленные отзывы и
          быстрый возврат к материалам.
        </p>
      </section>
          ...
          data.map((course, index) => (
            ...
            >
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-sm text-slate-500">{course.authorId}</p>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <Link to={"/courses" + "/" + String(course.id) + "/lesson/1"}>
